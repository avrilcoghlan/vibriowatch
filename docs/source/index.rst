...
Vibriowatch is a `PathogenWatch`_ database for *V. cholerae*. Vibriowatch contains `>4000` published *V. cholerae* genomes, and manually-curated metadata from the literature, including strain names; place, date and source of isolation; and phenotypic data for biotype, serogroup, serotype and antimicrobial resistance. 
